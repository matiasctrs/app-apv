...
img = image_select(
    ...
    images = ["https://github.com/matiasctrs/app-apv/blob/main/gato%20prueba.jpg",
              "https://github.com/matiasctrs/app-apv/blob/main/vertical.png"],
...
st.session_state["Pv row tilt"] = st.number_input("Ingresa el tilt en °",min_value=0, max_value=189, value = 60, help ="Inclinación de los módulos")
